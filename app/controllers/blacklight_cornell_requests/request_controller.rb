...
module BlacklightCornellRequests
  ...
  class RequestController < ApplicationController
    ...
    def magic_request target=''
      ...
      requestable_libraries = "Library Annex, Mann Library, Olin Library, Kroch Library Asia, Uris Library, ILR Library, Music Library, Africana Library, Fine Arts Library, Veterinary Library, Law Library"
